...
WEBUI_NAME = os.environ.get("WEBUI_NAME") or settings.get("appName", "Open WebUI")

WEBUI_FAVICON_URL = os.environ.get("WEBUI_FAVICON_URL") or settings.get("favicon", {}).get("default", "https://openwebui.com/favicon.png")
