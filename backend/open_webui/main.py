...
####################################
# Loading customization file
####################################
# Path to ../../customization.json
customization_path = Path(__file__).resolve().parents[2] / "customization.json"
with open(customization_path, "r") as f:
    settings = json.load(f)
print("Custom Settings Loaded Succesfully!")
...
frontend_url = os.environ.get("FRONTEND_URL") or settings.get("frontend", {}).get("url") or "https://app.useprivate.ai"
print(f"\n\nCurrent Frontend URL: {frontend_url}\n\n")
print(settings)
allowed_origins = [
    frontend_url,
    "https://login.useprivate.ai",
    "https://app.useprivate.ai",
    "https://webhook.site",  
    "https://fancy-together-shepherd.ngrok-free.app"
]
...
async def get_manifest_json():
    if app.state.EXTERNAL_PWA_MANIFEST_URL:
        ...
        return {
            ...
            "description": "PrivateAI is an open, extensible, user-friendly interface for AI that adapts to your workflow.",
            "start_url": "/",
            "display": "standalone",
